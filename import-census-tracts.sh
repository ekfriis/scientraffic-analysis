...
echo "select aland, ogc_fid, ST_Transform(ST_Buffer(wkb_geometry, -1E-3), 4326) AS geom INTO tl_2011_06_tract_buffered from tl_2011_06_tract where aland > 0;" | psql osrm osm
